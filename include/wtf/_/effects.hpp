...
namespace wtf{
  ...
  namespace _{
    ...
    struct effects{
      ...
      static void draw_border(const device_context& dc, const rect<coord_frame::client>& oclient, border_styles style, const pen& highlight, const pen& shadow, bool left=true, bool top=true, bool right=true, bool bottom=true){
        bool bInvert = false;
